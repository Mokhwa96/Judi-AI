...
def model(api_key, file_path, result_text):
  # message = chatbot(api_key, input_text)
  similar_sentences = get_similar_sentences(api_key, file_path, result_text)
...
if __name__ == "__main__":
  ...
  file_path = "C:/Users/gjaischool/Desktop/My_coding/final_projects/JUDIAI/hh/"
